...
from legged_gym.envs.M20_stairs.m20_stairs_config import M20_Cfg_Yu_Stairs

class M20_Robot_Stairs(BaseTask):
    def __init__(self, cfg: M20_Cfg_Yu_Stairs, sim_params, physics_engine, sim_device, headless):
