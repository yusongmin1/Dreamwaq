...
from legged_gym.envs.go2w.go2w_config import GO2W_Cfg

class Go2w(BaseTask):
    def __init__(self, cfg: GO2W_Cfg, sim_params, physics_engine, sim_device, headless):
