...
class LeggedRobot(BaseTask):
    ...
    def step(self, actions):
        ...
        return self.obs_buf, self.privileged_obs_buf,  self.obs_hist_buf,self.rew_buf, self.reset_buf, self.extras ## do we need to return obs history buffer??self.vel_buf,
